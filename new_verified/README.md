...
- `training/` simplified-transformer layer comparison results and three-model comparison (hard / softmax / logistic regression)
- `plots/` improved visualizations for 1/2/3 layer comparison and three-model metrics/ROC
...
python3 new_verified/run_verified_three_model_compare.py
python3 new_verified/make_better_visualizations.py
```
