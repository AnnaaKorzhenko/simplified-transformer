...
on the new dataset from generator_updated/dataset/.
"""
...
def main():
    """Train all three models on the new dataset."""
    
    dataset_dir = "generator_updated/dataset"
    formula_id = 33
    
    print("=" * 80)
    print("TRAINING ALL MODELS ON NEW DATASET")
    print("=" * 80)
    ...
    print("=" * 80)
    try:
        hard_result = train_transformer_hard(dataset_dir, formula_id, output_dir="generator_updated/results")
    ...
    print("=" * 80)
    try:
        soft_result = train_transformer_softmax(dataset_dir, formula_id, output_dir="generator_updated/results")
    ...
    results_file = "generator_updated/results/all_models_results.json"
