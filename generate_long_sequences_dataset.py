"""
Generate a dataset with very long sequences.
Using formula 34 (complex formula) but with longer sequences.
"""
...
# Parameters - using longer sequences
formula_id = 35  # New ID for long sequences dataset
alphabet_size = 50
num_disjunctions = 4
num_conjunctions = 3
sequence_length = 20  # Much longer sequences
num_positive = 5000
num_negative = 5000
...
print("=" * 70)
print(f"Generating Long Sequences Dataset - Formula {formula_id}")
print("=" * 70)
print(f"Parameters:")
print(f"  Alphabet size: {alphabet_size}")
print(f"  Disjunctions: {num_disjunctions}")
print(f"  Conjunctions per disjunction: {num_conjunctions}")
print(f"  Sequence length: {sequence_length} (very long)")
...
# Generate formula (same complexity as formula 34)
...
print(f"\nGenerating {total_sequences} sequences with length {sequence_length}...")
print("(This may take a while due to longer sequences)")
