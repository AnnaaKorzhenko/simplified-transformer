...
on the complex dataset (formula 34).
"""
...
def main():
    """Train all three models on the complex dataset."""
    
    dataset_dir = "generator_updated/dataset"
    formula_id = 34  # Complex formula
    
    print("=" * 80)
    print("TRAINING ALL MODELS ON COMPLEX DATASET")
    print("=" * 80)
    print(f"Dataset: {dataset_dir}")
    print(f"Formula ID: {formula_id} (Complex: 4 disjunctions, 3 conjunctions, length 10)")
    print("=" * 80)
    print()
    ...
    # Print summary
    print("\n" + "=" * 80)
    print("SUMMARY OF ALL RESULTS - COMPLEX DATASET")
    print("=" * 80)
    ...
    results_file = "generator_updated/results/all_models_results_complex.json"
